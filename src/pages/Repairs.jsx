  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "60px 24px" }}>
        ...
        >
          Report and track all maintenance requests including electrical, plumbing, and AC issues. Ensure quick resolution and smooth hospital operations.
        </p>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Report and track electrical issues like lighting, wiring, and equipment faults.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Quickly address plumbing issues to ensure smooth hospital operations.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Monitor and schedule maintenance for air conditioning and ventilation systems.
            </p>
          </div>
        </div>
      </main>
