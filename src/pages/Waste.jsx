  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "60px 24px" }}>
        ...
        >
          Efficient biomedical waste disposal and room sanitization services to maintain hygiene and safety across the hospital.
        </p>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Proper segregation and disposal of medical waste to ensure safety.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Scheduled cleaning and disinfection of patient rooms and common areas.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Follow strict hygiene protocols to protect staff and patients.
            </p>
          </div>
        </div>
      </main>
