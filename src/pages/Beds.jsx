  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "60px 24px" }}>
        ...
        >
          Efficiently track room occupancy and bed availability. Monitor discharge readiness and optimize patient allocation for smooth hospital operations.
        </p>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Check the number of beds currently available across different wards and rooms.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Monitor patients who are ready for discharge to optimize bed turnover.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Keep track of room occupancy, cleaning status, and maintenance needs.
            </p>
          </div>
        </div>
      </main>
