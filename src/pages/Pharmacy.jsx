  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "60px 24px" }}>
        ...
        >
          Manage medicine stock, track expiry dates, and distribute prescriptions efficiently. Ensure proper inventory and timely supply for patients and hospital staff.
        </p>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Monitor medicine stock levels and receive alerts for low supplies.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Keep track of expiration dates to avoid dispensing expired medicines.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Efficiently manage prescriptions and ensure correct distribution to patients.
            </p>
          </div>
        </div>
      </main>
