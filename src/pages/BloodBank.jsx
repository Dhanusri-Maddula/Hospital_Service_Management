  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "60px 24px" }}>
        ...
        >
          Track bed availability, discharge readiness, and allocate rooms efficiently to improve hospital operations.
        </p>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              View real-time availability of all beds in the hospital.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Keep track of patient discharge status to free up rooms efficiently.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#4b5563" }}>
              Assign beds to patients efficiently and avoid conflicts or overbooking.
            </p>
          </div>
        </div>
      </main>
